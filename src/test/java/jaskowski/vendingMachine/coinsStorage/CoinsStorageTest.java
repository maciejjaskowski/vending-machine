...
import jaskowski.vendingMachine.GivenCoinsRepository;
...
import static jaskowski.vendingMachine.money.Coin.*;
import static java.util.Arrays.asList;
import static org.fest.assertions.Assertions.assertThat;

@RunWith(MockitoJUnitRunner.class)
public class CoinsStorageTest {

    @Mock
    private CoinsDispenser coinsDispenser;
    private CoinsStorage coinsStorage = new CoinsStorage(new GreedyCoinsChangerFactory());
